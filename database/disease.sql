...
VALUES (6, 'Admin', 'a0a475cf454cf9a06979034098167b9e');
-- --------------------------------------------------------
--
...
INSERT INTO `disease_tb` (`id`, `disease_id`, `disease_name`, `cause`)
VALUES (
        1,
        1,
        'Cataracts',
        'Build Up Protein in an Eye .Present From Birth .Eye injuries .If not treated properly cause Blindness.'
    ),
    (
        2,
        2,
        'trachoma',
        'Water shortage , poor sanitation and infestation of files . Repeated infections with bacteria known as chamydia travhoma .'
    ),
    (
        3,
        3,
        'Keratotoconjunctives sicca ',
        'Dry eyes ,causes Eye infections .'
    ),
    (
        4,
        4,
        'Macular Degeneration',
        'Smoking ,Obesity ,Cardiovascular Disease ,Family history and genetics .'
    ),
    (
        5,
        5,
        'Astigmatism ',
        'Blurred distance and near vision.Astigmatism is often present at birth and may occur  in combination with nearsightedness and farsightedness.'
    ),
    (
        6,
        6,
        'Uvetils',
        'Symptoms may occur suddenly and may get worse quickly . Though in some cases they grow gradually .They may affect one or both eyes .It can be serious permanent vision loss .'
    ),
    (
        7,
        7,
    ...
    (
        ...
        'Usually affects both eyes .Careful about your diabetics is the best way to prevent permanent vision loss .'
    ),
    (
        9,
        9,
        'Hordoleum',
        'Most sites are harmless to your eye and won\'t affect your ability to see clearly .Try self care measures first .,such as applying wash cloth to your closed .'
    ),
    (
        10,
        10,
        'Conjunctives ',
        'Serious eye conditions that cause eye redness .May cause eye pain,a feeling that something is stuck in your eye .If symptoms don\'t get better during 12-24 hours then make an appointment to your doctor .'
    ),
    (
        11,
        0,
        'Sorrry,Less Information.Select information Properly.',
        'To Show your disease You have to select the symptoms that you face.After selecting the symptoms you can get your result .'
    ),
    (
        12,
        12,
        'Canker Sores.',
        'Possible triggers for canker sores include: A minor injury to your mouth from dental work, overzealous brushing, sports mishaps or an accidental cheek bite. Toothpastes and mouth rinses containing sodium lauryl sulfate.'
    ),
    (
        13,
        13,
    ...
    (
        ...
        14,
        'Dental Health.',
        'Risk factors for oral and dental ill health include poor diet and hygiene, trauma, stress, smoking, alcohol use, and use of illegal substances. These are also common risk factors for other chronic diseases.'
    ),
    (
        15,
        15,
        'Dry Mouth.',
        'Dry mouth, or xerostomia (zeer-o-STOE-me-uh), refers to a condition in which the salivary glands in your mouth don\'t make enough saliva to keep your mouth wet. Dry mouth is often due to the side effect of certain medications or aging issues.'
    ),
    (
        16,
        16,
    ...
    (
        ...
        'Dry mouth is caused when the salivary glands in the mouth don\'t make enough saliva to keep your mouth wet. These glands may not work properly as the result of: Medications. '
    ),
    (
        19,
        19,
        'Autoimmune Diseases',
        'Multiple sclerosis, or MS, is a disease of the central nervous system in which the body’s immune system attacks myelin, the tissue that covers nerves. This interferes with neural communication between the brain and the body.'
    ),
    (
        20,
        20,
        'Autism and Neural Development Diseases',
        'Autism spectrum disorder is a developmental condition that affects an individual’s ability to communicate and interact with others. The disorder can be diagnosed at any age, but symptoms typically appear within the first two years of life.'
    ),
    (
        21,
        21,
        'Dementia',
        'Symptoms of dementia include a progressive loss of cognitive and functional ability, leading to a loss of independence. There are currently no effective treatments, but many trials are underway that may offer hope to patients and their families.'
    ),
    (
        22,
        22,
        'Brain Infections',
        'Common brain diseases caused by an infection include meningitis and encephalitis. Meningitis is an infection in the lining around the brain or spinal cord. Encephalitis is an infection of the brain tissue.'
    ),
    (
        23,
        23,
        'Movement Disorders',
        'Parkinson’s disease, ataxias, tremor, dystonia, tics and Tourette syndrome are examples of movement disorders that often progress to a complete loss of function. They can lead to tremors, slow and stiff movement, loss of balance.'
    ),
    (
        24,
        24,
        'Neuromuscular Diseases',
        'These disorders attack peripheral nerves outside the brain and the muscles they control. Amyotrophic lateral sclerosis, commonly referred to as ALS or Lou Gehrig’s disease, is the best known of these diseases.'
    ),
    (
        25,
        25,
        'Seizure Disorders',
        'Epilepsy and other seizure disorders affect about 3.4 million people, according to the Centers for Disease Control and Prevention. Seizures are caused by a disruption in brain activity, either because of illness, brain damage or other factors.'
    ),
    (
        26,
        26,
        'Stroke and Vascular Diseases',
        'Stroke is the leading cause of permanent disability in adults. An ischemic stroke is when blood flow to the brain is impaired by a blocked blood vessel. A hemorrhagic stroke is when a blood vessel in the brain ruptures, causing bleeding into the brain.'
    ),
    (
        27,
        27,
        'Trauma',
        'Trauma, including concussion, can be mild or severe, and can cause anything from a mild headache to confusion, loss of consciousness, convulsions and even death. Benish stresses the importance of head protection for everyone.'
    ),
    (
        28,
        28,
        'Tumors',
        'Both benign and malignant tumors can put pressure on brain tissue or destroy tissue, causing problems in the body associated with the area of the brain affected. Tumors can start within the brain or metastasize there from other organs.'
    ),
    (
        29,
        29,
        'Scoliosis',
        'Most often, the cause of scoliosis, or abnormal curvature of the spine, is unknown – called idiopathic scoliosis. In other cases, it may be degenerative and occur as a person ages.'
    ),
    (
        30,
        30,
        'Spina Bifida',
        'This birth defect – specifically what’s called a neural tube defect – occurs on a continuum: It can be more or less severe. The most severe form is known as myelomeningocele.Depending upon severity, spina bifida can lead to a range of complications.'
    ),
    (
        31,
        31,
        'Bell’s Palsy',
        'This condition causes temporary paralysis or weakness of one side of the face. “It’s a loss of function of the seventh cranial nerve,” Lawton explains. '
    ),
    (
        32,
        32,
    ...
    (
        ...
        39,
        'Fungal sinusitis ',
        'Fungal infection of the sinuses can occur when fungal organisms are inhaled and deposited in the nasal passageways and paranasal sinuses, causing inflammation. The dark, moist environment of the sinuses is ideal for fungi.'
    ),
    (
        40,
        40,
        'Inverting papilloma ',
        'Although it is believed that viral infection, chronic inflammation and cigarette smoking can play an important etiological role, it has recently been suggested that occupational risk factors, such as those involved in malignant epithelial .'
    ),
    (
        41,
        41,
    ...
    (
        ...
        42,
        'Nasal fractures',
        'A nasal fracture, commonly referred to as a broken nose, is a fracture of one of the bones of the nose. Symptoms may include bleeding, swelling, bruising, and an inability to breathe through the nose.'
    ),
    (
        43,
        43,
    ...
    (
        ...
        45,
        'Asthma.',
        'There are two main types of medications used to treat asthma: Long-term control medications such as inhaled corticosteroids are the most important medications used to keep asthma under control. These preventive medications treat the airway inflammation.'
    ),
    (
        46,
        46,
    ...
    (
        ...
        49,
        'Lung Cancer.',
        'Lung cancer may not produce any noticeable symptoms in the early stages, and many people aren’t diagnosed until the disease has advanced. Read on to learn about nine early lung cancer symptoms, and how early screening may help people at high risk . '
    ),
    (
        50,
        50,
        ' Cystic Fibrosis/Bronchiectasis',
        'Bronchiectasis is an under-diagnosed condition. If it is suspected, your doctor will first require a detailed family history and blood tests to dete rmine whether you may have an underlying condition that could cause  Bronchiectasis.'
    ),
    (
        51,
        51,
    ...
    (
        ...
        52,
        'Pleural Effusion.',
        'This usually happens if you have congestive heart failure, when  your heart doesn\'t pump blood to your body properly. But it can also come from liver or kidney disease, when fluid builds up in your body and leaks into the pleural space.'
    ),
    (
        53,
        53,
    ...
    (
        ...
        'When stomach acid backs up into your esophagus — a condition called acid reflux — you may feel a burning pain in the middle of your chest. It often occurs after meals or at night,'
    ),
    (
        57,
        57,
        'Gallstones',
        'Gallstones are hard deposits that form in your gallbladder — a small, pear-shaped sack that stores and secretes bile for digestion.Medications sometimes dissolve gallstones, but if that doesn’t work, the next step is surgery to remove the gallbladder. '
    ),
    (
        58,
        58,
    ...
    (
        ...
        59,
        'Crohn\'s Disease',
        'Crohn’s disease is part of a group of digestive conditions called inflammatory bowel disease (IBD). Doctors aren\'t sure what causes the disease, but it\'s thought that genetics and family history may play a part. '
    ),
    (
        60,
        60,
    ...
    (
        ...
        64,
        ' Anal Fissure',
        'A high-fiber diet that makes your stool well formed and bulky is often the best treatment for this common digestive condition.'
    ),
    (
        65,
        65,
        'Bursitis/Rotator Cuff Tendonitis',
        'This occurs when there is inflammation of the rotator cuff tendons and the bursa that surrounds these tendons. Often there is an initial injury that sets off the process of inflammation which means the problem can be self-exacerbating.'
    ),
    (
        66,
        66,
        'Shoulder Arthritis',
        'Treatment of shoulder arthritis should begin with the most basic steps, and progress to the more involved, possibly including surgery.  Not all treatments are appropriate in every patient, and you should have a discussion with your doctor to determine.'
    ),
    (
        67,
        67,
        'Otitis Externa.',
        'Otitis externa is a condition that causes inflammation (redness and swelling) of the external ear canal, which is the tube between the outer ear and eardrum.With treatment, these symptoms should clear up within a few days. However, some cases can persist '
    ),
    (
        68,
        68,
    ...
    (
        ...
        72,
        'Otosclerosis',
        'Otosclerosis is a serious bone deformation is a common cause of hearing loss for people in their twenties and thirties. The human ear contains three little bones that serve as sound transmitters from the outer to inner ear. '
    ),
    (
        73,
        73,
    ...
    (
        ...
        76,
        'Arthritis',
        'You may have joint inflammation for a variety of reasons, including:An autoimmune disease (the body attacks itself because the immune system believes a body part is foreign) , Broken bone , General \"wear and tear\" on joints, Infection.'
    ),
    (
        77,
        77,
        'Tendinitis',
        ' Tendinitis usually happens after repeated injury to an area such as the wrist or ankle. It causes pain and soreness around a joint. Some common forms of tendinitis are named after the sports that increase their risk. They include tennis elbow, golfer\'s e'
    ),
    (
        78,
        78,
        'Bursitis',
        ' Bursitis occurs when a bursa becomes inflamed. People get bursitis by overusing a joint. It can also be caused by an injury. It usually occurs at the knee or elbow.'
    ),
    (
        79,
        79,
    ...
    (
        ...
        81,
        'Fracture',
        'Most often a displaced fracture in the radius and a dislocation of the ulna at the wrist, where the radius and ulna come together.'
    ),
    (
        82,
        82,
        'Arthritis.',
        'Arthritis can occur in the wrist or elbow, causing a dull ache in the forearm. An underlying condition: Certain medical conditions, such as angina, can cause pain in the forearm.'
    ),
    (
        83,
        83,
    ...
    (
        ...
        'Musculoskeletal pain is pain that affects the muscles, ligaments and tendons, and bones.The causes of musculoskeletal pain are varied. Muscle tissue can be damaged with the wear and tear of daily activities.'
    ),
    (
        90,
        90,
        'Pinched Spinal Nerve',
        'Thigh pain may be caused by a pinched spinal nerve. Herniated lumbar discs or low back arthritis may pinch on the nerves that exit your spinal column and travel down your thigh.'
    ),
    (
        91,
        91,
    ...
    (
        ...
        'Your iliotibial band is a thick piece of fascia and tissue that courses down the outer side of your thigh. Sometimes it can become irritated with overuse or repeated stress. '
    ),
    (
        94,
        94,
    ...
    (
        ...
        100,
        'Dislocations',
        'The cause is often a fall or a blow, sometimes from playing a contact sport. You can dislocate your ankles, knees, shoulders, hips, elbows and jaw. You can also dislocate your finger and toe joints.'
    ),
    (
        101,
        101,
        'Fractures',
        'If the broken bone punctures the skin, it is called an open or compound fracture. Fractures commonly happen because of car accidents, falls, or sports injuries.'
    ),
    (
        102,
        102,
        'Peripheral Nerve Disorders',
        'Some people are born with peripheral nerve disorders.others are from nerve compression, like carpal tunnel syndrome or thoracic outlet syndrome. In some cases, like complex regional pain syndrome and brachial plexus injuries.'
    ),
    (
        103,
        103,
    ...
    (
        ...
        104,
        'fractures',
        'A fracture is a crack or break in a bone. Most fractures result from force applied to a bone. '
    ),
    (
        105,
        105,
    ...
    (
        ...
        ' the immune system doesn’t work properly and releases inflammatory chemicals. The resulting inflammation attacks joint tissues and can cause joint swelling, increased joint fluid, cartilage and bone damage, and muscle loss. '
    ),
    (
        107,
        107,
    ...
    (
        ...
        108,
        'Arthritis',
        'Osteoarthritis is often called “wear-and-tear arthritis” and is caused by the cartilage in joints wearing away over time.'
    ),
    (
        109,
        109,
        'Trigger Finger',
        'Trigger finger may develop after forceful hand use.'
    ),
    (
        110,
        110,
    ...
    (
        ...
        'Gonorrhea is a sexually transmitted disease (STD) caused by infection with the Neisseria gonorrhoeae bacterium. N. gonorrhoeae infects the mucous membranes of the reproductive tract, including the cervix, uterus, and fallopian tubes in women.'
    ),
    (
        112,
        112,
        ' Chlamydia trachomatis.',
        'The parasite Chlamydia trachomatis causes a variety of disorders—in women, urethritis, cervicitis, and salpingitis (inflammation of the ureter, cervix, and fallopian tubes, respectively) and, in men, nongonococcal urethritis.'
    ),
    (
        113,
        113,
    ...
    (
        ...
        'Most healthy women have these bacteria in their cervix or vagina, and a smaller number of men also have them in their urethra.'
    ),
    (
        115,
        115,
    ...
    (
        ...
        116,
        'Chlamydia trachomatis',
        'Chlamydia trachomatis is a common sexually transmitted infection (STI) caused by bacteria. You might not know you have chlamydia because many people don\'t have signs or symptoms, such as genital pain and discharge from the vagina or penis.'
    ),
    (
        117,
        117,
    ...
    (
        ...
        'The rectus-adductor syndrome is a form of groin pain caused by microtraumas which consists of a chronic inflammation in the insertion point onto the pubis, that is, of the tendons of the adductors and rectus abdominis (see fig. beside). '
    ),
    (
        120,
        120,
    ...
    (
        ...
        'Symphysis pubis dysfunction (SPD) is a group of symptoms that cause discomfort in the pelvic region. It usually occurs during pregnancy, It can occur both at the front and back of your pelvis. '
    ),
    (
        122,
        122,
    ...
    (
        ...
        123,
        'Fractures',
        'The bones of the knee, including the kneecap (patella), can be broken during motor vehicle collisions or falls. '
    ),
    (
        124,
        124,
    ...
    (
        ...
        135,
        'Sprains and strains',
        'Sprains and strains occur when the body is put under physical stress.'
    ),
    (
        136,
        136,
...
--
INSERT INTO `symptoms_tb` (
        `id`,
        `symptoms_id`,
        `symptoms_name`,
        `disease_id`
    )
VALUES (1, 1, 'Double vision in  a single eye ', 1),
    ...
    (
        10,
        10,
        'Gritty , Burning and stinging in the eyes ',
        10
    ),
    ...
    (
        63,
        45,
        'redness or swelling over your jaw in front of your ears, below your jaw, or on the your mouth.',
        18
    ),
    ...
    (
        68,
        49,
        ' uncoordinated or clumsy balance, speech or limb movements',
        23
    ),
    (
        69,
    ...
    (
        85,
        63,
        'low blood pressure and impaired bladder function.',
        23
    ),
    (
        86,
        64,
        'abnormal feelings in the legs while relaxing or lying down, often relieved by movement.',
        23
    ),
    ...
    (
        97,
        69,
        'Uncontrollable jerking movements of the arms and leg',
        26
    ),
    (
        98,
    ...
    (
        99,
        71,
        'distressing, unwanted memories, vivid nightmares and/or flashbacks',
        27
    ),
    (
        100,
    ...
    (
        101,
        73,
        'trouble sleeping or concentrating, feeling angry or irritable, taking risks',
        27
    ),
    ...
    (
        187,
        37,
        'bleeding of the nose and nasal region of the face',
        42
    ),
    ...
    (
        320,
        190,
        'lose feeling in their hand or lose a pulse ',
        80
    ),
    (
        321,
    ...
    (
        335,
        203,
        'Greater sensitivity to a light touch than to firm pressure',
        89
    ),
    (
        336,
        204,
        'Groin pain that spreads across the buttocks',
        89
    ),
    ...
    (
        359,
        308,
        'fingers feels like it is locking or catching when try to bend it.',
        109
    ),
    ...
    (
        366,
        314,
        'pain when running or doing other activities',
        127
    ),
    ...
    (
        370,
        318,
        'pain in the groin or lower abdominal region wall',
        119
    ),
    (
        371,
    ...
    (
        373,
        321,
        'pain arises even during walking. ',
        119
    ),
    (
        374,
        322,
        'inflammation right and left pubic bones ',
        117
    ),
    (
        375,
...
VALUES (
    ...
    (
        16,
        'Nasim92',
        '5ec0b6355d9a5fdb2996c5b9950cc1c6',
        'princeneo58@gmail.com',
        '2020-04-09 13:34:26',
        50
    );
